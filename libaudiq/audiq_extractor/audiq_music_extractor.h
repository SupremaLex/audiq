...
class AudiqMusicExtractor : public essentia::standard::Algorithm {
 protected:
  essentia::standard::Input<std::string> _audiofile;
  essentia::standard::Output<Pool> _resultsStats;
  essentia::standard::Output<Pool> _resultsFrames;
